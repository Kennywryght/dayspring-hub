                ...
                <div className="mt-6 sm:mt-8 md:mt-10">
                  <div className="flex flex-col sm:flex-row gap-3 w-full">
                    <button
                      ...
                      className="w-full sm:w-auto bg-brass-600 hover:bg-brass-700 text-white px-8 py-4 rounded-2xl text-base font-semibold shadow-soft transition-all duration-300 active:scale-95 text-center flex items-center justify-center gap-2"
                    >
                      Get Started <ArrowRight className="w-4 h-4" strokeWidth={1.75} />
                    </button>
                    <a
                      href="#features"
                      onClick={playClick}
                      className="w-full sm:w-auto bg-white dark:bg-navy-800 border-2 border-ink-200 dark:border-navy-600 hover:border-brass-300 dark:hover:border-brass-500 text-navy-700 dark:text-ink-200 px-8 py-4 rounded-2xl text-base font-semibold transition-all duration-300 text-center active:scale-95"
                    >
                      Learn More
                    </a>
                  </div>
                ...
                <div className="bg-navy-800 rounded-2xl sm:rounded-[2rem] p-4 sm:p-6 md:p-8 shadow-elevated">
                  <div className="bg-white dark:bg-navy-700 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-card border border-navy-600/30">
                    <div className="space-y-3 sm:space-y-5">
                      {[
                        { Icon: BookOpen, title: 'Learning Materials', desc: 'Upload notes, PDFs & resources', bg: 'bg-navy-50 dark:bg-navy-600/30' },
                        { Icon: ClipboardList, title: 'Assignment Tracking', desc: 'Submit and review work easily', bg: 'bg-navy-50 dark:bg-navy-600/30' },
                        { Icon: Megaphone, title: 'Real-Time Updates', desc: 'School announcements instantly', bg: 'bg-navy-50 dark:bg-navy-600/30' },
                      ].map((item, idx) => (
                        <div key={idx} className={`flex items-center gap-3 p-3 rounded-xl sm:rounded-2xl ${item.bg} animate-fade-in-up`} style={{ animationDelay: `${idx * 0.15}s` }}>
                          ...
                          <div className="min-w-0 flex-1">
                            <h3 className="font-semibold text-sm sm:text-base text-navy-800 dark:text-white">{item.title}</h3>
                            <p className="text-xs sm:text-sm text-ink-500 dark:text-ink-400">{item.desc}</p>
                          </div>
                        </div>
                      ))}
                    </div>
