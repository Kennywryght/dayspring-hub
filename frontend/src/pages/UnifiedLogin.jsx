...
export default function UnifiedLogin() {
  ...
  // Role config — colors borrowed from the same institutional palette used everywhere else,
  // not a separate rainbow. Each role maps to one existing token.
  const roleConfig = {
    teacher: {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-parchment dark:bg-navy-900 p-4 sm:p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-navy-800 rounded-3xl border border-ink-200 dark:border-navy-600 shadow-elevated overflow-hidden">
          {/* Header */}
