...
export default function LandingPage() {
  ...
  // Removed background image slideshow – kept the blobs instead
  const backgroundImages = [];   // not used
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 overflow-hidden relative transition-colors duration-300">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Animated floating blobs – reduce opacity in dark mode */}
        ...
        <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/70 dark:bg-gray-900/70 border-b border-gray-100 dark:border-gray-800 animate-slide-down">
          <nav className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-3 cursor-pointer transition-transform hover:scale-105">
              <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-blue-200 dark:border-blue-500/30 shadow-md flex-shrink-0">
                <img
                  src="/logo.jpg"
          ...
          {/* Mobile menu */}
          <div
            className={`md:hidden bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 px-6 pb-4 transition-all duration-300 ease-out ${
